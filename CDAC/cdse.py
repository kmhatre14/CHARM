...
# cdse_top_direct_estimate function generates the estimate for latency directly from the supplied input configuration for a b c 
# and x y z 

def cdse_top_direct_estimate(MODEL_IN,HW_Part,DATA_TYPE,log,design,acc):
